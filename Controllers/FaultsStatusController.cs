...
{
    public class FaultsStatusController : Controller
    {
        private readonly AuthenticationContext _context;

        public FaultsStatusController(AuthenticationContext context)
        {
            _context = context;
        }

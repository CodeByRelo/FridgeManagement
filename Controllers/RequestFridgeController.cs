...
{
    public class RequestFridgeController : Controller
    {
        private readonly AuthenticationContext _context;

        public RequestFridgeController(AuthenticationContext context)
        {
            _context = context;
        }
        ...
        // GET: RequestFridge/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: RequestFridge/Create

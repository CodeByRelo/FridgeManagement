...
{
    public class UpdateFridgeController : Controller
    {
        private readonly AuthenticationContext _context;

        public UpdateFridgeController(AuthenticationContext context)
        {
            _context = context;
        }
